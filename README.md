...
```bash
heroku config:set FREETDS_VERSION=1.3.17
```
...
or use a stable tag, like [v1.1.5](https://github.com/thoughtbot/heroku-buildpack-freetds/tree/v1.154)

```bash
heroku buildpacks:set --index 1 https://github.com/thoughtbot/heroku-buildpack-freetds#v1.1.5
```

## Changelog

- HEAD. [Diff](https://github.com/thoughtbot/heroku-buildpack-freetds/compare/v1.1.4...master)
- 1.1.5 Update FREETDS_VERSION from 1.00.109 to 1.3.17 [Diff](https://github.com/thoughtbot/heroku-buildpack-freetds/compare/v1.1.4...v.1.1.5)
